...
export function LoginForm({ onToggle }: { onToggle?: () => void }) {
  ...
  return (
    <div className="w-full max-w-sm p-10 space-y-6 bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 shadow-2xl flex flex-col items-center">
      ...
      <form className="space-y-8 w-full" onSubmit={handleLogin}>
       ...
       <p className="text-center text-xs text-gray-400 w-full">
        Don't have an account? <button onClick={onToggle} className="font-semibold text-blue-400 hover:text-blue-300 transition">Sign Up</button>
      </p>
    </div>
  );
}
...
/**
 * A glassmorphism-style sign up form component matching the login form's aesthetic.
 */
  ...
  return (
    <div className="w-full max-w-sm p-10 space-y-6 bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 shadow-2xl flex flex-col items-center">
      <div className="text-center w-full">
        ...
        <p className="mt-2 text-sm text-gray-300">Join us to get started</p>
      </div>
      <form className="space-y-8 w-full" onSubmit={handleSignUp}>
        {error && <p className="text-red-400 text-xs text-center">{error}</p>}
        {/* Full Name Input */}
        <div className="relative z-0 w-full">
          <input
       ...
       <p className="text-center text-xs text-gray-400 w-full">
        Already have an account? <button onClick={onToggle} className="font-semibold text-blue-400 hover:text-blue-300 transition">Sign In</button>
      </p>
    </div>
  );
}
...
/**
 * A redirecting page shown after email verification.
